 ...
 *
 * @constructor
 * @augments {VM.Workspace}
 */
VM.JavaWorkspace = function (msg) {

  /** Base class to inherit from. */
  var base = new VM.Workspace(msg);
  ...
  /** Determines the working root path for the workspace.
   *
   * TODO (matias.mirabelli): resolve how to handle workspaces directory tree.
   *
   * @return {String} A valid directory to write query information and buffers.
   */
  var getWorkingDir = function () {
    return "/tmp/nodde-build-utils";
  };
